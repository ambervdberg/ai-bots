...
`;var fe=Object.defineProperty,ge=Object.getOwnPropertyDescriptor,Y=(r,t,e,o)=>{for(var s=o>1?void 0:o?ge(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&fe(t,e,s),s};let C=class extends f{constructor(){super(...arguments),this.name="Sign in",this.ms=!1,this.disabled=!1}render(){return u`
    ...
    `}};C.styles=ue;Y([g({type:String})],C.prototype,"name",2);Y([g({type:Boolean})],C.prototype,"ms",2);Y([g({type:Boolean})],C.prototype,"disabled",2);C=Y([_("login-button")],C);var be=Object.defineProperty,me=Object.getOwnPropertyDescriptor,Nt=(r,t,e,o)=>{for(var s=o>1?void 0:o?me(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&be(t,e,s),s};let ot=class extends f{constructor(){super(...arguments),this.name="Sign in with Google"}googleLogin(){const r=location.hash.replace("#","?"),t=location.origin+location.pathname+r,e=`https://accounts.google.com/o/oauth2/v2/auth?client_id=${vt.clientId}&redirect_uri=${t}&response_type=token&scope=${encodeURI(vt.scopes)}`;window.location.href=e}render(){return u` <login-button .name=${this.name} @click=${this.googleLogin}>
      <svg
        version="1.1"
...
`;var Ue=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,Re=(r,t,e,o)=>{for(var s=o>1?void 0:o?Me(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&Ue(t,e,s),s};const L={HOME:"",POEM:"#poem",NOTION:"#notion"};let it=class extends f{constructor(){super(...arguments),this.handleHashChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),window.addEventListener("hashchange",this.handleHashChange)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this.handleHashChange)}render(){return u`
    ...
    `}};it.styles=Ne;it=Re([_("ai-bot-app")],it);document.addEventListener("DOMContentLoaded",()=>{A.handleAuthResponse()});
