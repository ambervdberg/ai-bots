(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const kt="https://function-app-ai-bots.azurewebsites.net/api",D="code",be="auth_token",zt="access_token";class j{static async isAuthenticated(){const e=localStorage.getItem(be);if(!e)return localStorage.removeItem(D),!1;if(localStorage.getItem(D))return!0;try{const n=await fetch(`${kt}/auth-google?access_token=${e}`);if(n.status!==200)return!1;const i=await n.text();return localStorage.setItem(D,i),!0}catch(n){return console.error("Authentication error:",n),!1}}static handleAuthResponse(){const t=new URLSearchParams(window.location.hash.substring(1)).get(zt);t&&(localStorage.setItem(be,t),j.isAuthenticated())}static logout(e){localStorage.removeItem(be),localStorage.removeItem(D),e&&(window.location.href=e)}static getCode(){return localStorage.getItem(D)}}/**
 * @license
